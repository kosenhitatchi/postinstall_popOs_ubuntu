#! /bin/bash
# Remi Cambuzat - Remi Cambuzat - 11/Nov/2020
# A Simple post installation script to setup ubuntu install
# Customised to fit Pop!_OS 20.04 LTS ( Custom ubuntu 20.04 LTS build)
################################################################################
# Ubuntu (> 9.10) post installation script
# Based on VoidAndAny script : http://voidandany.free.fr/index.php/installer-de-facon-automatique-une-liste-de-package-et-les-depots-associes/
#
